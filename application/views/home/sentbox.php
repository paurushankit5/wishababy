		...
		<div class="fh5co-pricing">
			<div class="container-fluid">
				...
				<div class="row">
							...
							<div>
								<div class="price-box to-animate-2 popular" style="background-image:url(<?= base_url('assets/front/sidebar/sidebar-1.jpg');?>);background-size:cover;width:100%;text-align:left;">
									<ul class="nav nav-pills nav-stacked" style="font-size:14px;">
										<li  style="border:1px solid white;border-radius:4px;"><a style="color:white;" href="<?= base_url('Message/inbox');?>"><b>Inbox</b></a></li>
										<li class="active"   style="border:1px solid white;border-radius:4px;"><a style="color:white;" href="<?= base_url('Message/sentbox');?>"><b>Sentbox</b></a></li>
					...
					<div class="col-md-7">
						<h1 class="to-animate text-center">Sentbox</h1>
									...
									<?php
										foreach($message as $x)
										{
											...
											<tr>
												...
												<td>
													<a href="<?= base_url('Message/viewconverstaion/'.$x['message_rx_id']); ?>" >
														<?= $x['message_body'];?>
													</a>
												</td>
