	...
	<section id="fh5co-team" data-section="team" style="padding-top:0px;background:#ecf0f5;">
		<div class="fh5co-team">
			<div class="container">
				 ...
				 <br>
				<div class="row">				 
					<div class="col-sm-10 col-sm-offset-1 advertise" style="background:white;margin-top:80px;padding:30px;font-size:12px;">
						
						<center> <img src="<?= base_url('img/oops.jpg');?>" class="img img-responsive"/></center>
						<h1  class="text text-center text-primary">Error 404!... Page not found.</h1>
