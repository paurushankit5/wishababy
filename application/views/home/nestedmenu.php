...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title><?= $nest['nest_title'];?></title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="<?= $nest['nest_description'];?>" />
	<meta name="keywords" content="<?= $nest['nest_keyword'];?>" />
...
.homeservice{
	...
	<section id="fh5co-pricing" data-section="pricing">
		 <ol class="breadcrumb pull-right" style="font-size:12px;">
		  ...
		  <li class="breadcrumb-item"><a href="<?= base_url('wish/'.$nest['menu_slug']);?>"><?= $nest['menu_name'];?></a></li>
		  <li class="breadcrumb-item"><a href="<?= base_url('wish/'.$nest['menu_slug'].'/'.$nest['submenu_slug']);?>"><?= $nest['submenu_name'];?></a></li>
		  
		  <li class="breadcrumb-item active"><?= $nest['nest_name'];?></li>
		</ol>
							...
							<div class="">
								<div class="price-box to-animate-2 popular" style="background-image:url(<?= base_url('assets/front/sidebar/sidebar-1.jpg');?>);background-size:cover;width:100%;text-align:left;">
									<ul class="nav nav-pills nav-stacked" style="font-size:14px;">
										<li ><a href="#" style="background-color:red;color:white"><b><?= $menu[$j]['menu_name'];?></b></a></li>
						...
						<div class="pricing" style="    width: 100%;" >
							<div class="">
								<div class="price-box to-animate-2 popular  " style="width:100%;text-align:left;">
									 <h1 class="text-center"><b><?= $nest['nest_name'];?></b></h1> 
									 <?= $nest['nest_content'];?>
								</div>
							</div>						
						</div>
