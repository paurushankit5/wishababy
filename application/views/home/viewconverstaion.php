		...
		<div class="fh5co-pricing">
			<div class="container-fluid">
				 <ol class="breadcrumb pull-right" style="font-size:12px;">
					  ...
					  <li class="breadcrumb-item"><a href="<?= base_url('Messages/inbox');?>">Messages</a></li>
				...
				<div class="row">
					...
					<div class="col-md-7">
						<h1 class="to-animate text-center">Conversation</h1>
						<?php
							if(count($messages))
							{
								foreach($messages as $x)
								{
									if($x['message_sender_id']==$_COOKIE['wish_user_id'])
									{
										echo '<div class=" col-md-8 col-md-offset-4"><div class="right-bubble">';
									}
									else
									{
										echo '<div class="col-md-8"><div class="left-bubble">';
									}
									?>									
										  <div class="talktext">
											<p><?= $x['message_body'];?></p>
