		...
		<div class="row">
			...
			<div class="col-sm-12">
			 ...
			 <div class="col-md-4 col-sm-offset-4">
				<br>
				<button type="submit" onClick="findclinic();" style="border:1px solid white;opacity:0.8;font-size:16px;margin-top: 20px;padding: 18px 60px;border-radius: 4px;" class="btn btn-primary btn-block  btn-select-plan btn-sm pull-right">Find Clinic</button>
			</div>
			<br><br><br><br>
		</div>
	</div>
...
<script>
 ...
 function findclinic()
 {
	 ...
	 var user_type		=	2; //For clinic user_type is 2
	  if(user_service=='')
	 {
		...
		var count	=	0; 
		 $.ajax({
			...
			// data	:	'user_city='+user_city+'&user_state='+user_state+'&user_service='+user_service+'&user_type='+user_type+'&count='+count,
			 ...
			 url	:	'<?= base_url('search/findclinic');?>',
			 beforeSend : function(){$('.loadingDiv').show();},
			 success:	function(data)
			 {
			 	data = data.trim();
				...
				if(data	=='0')
				{
					$('#mainarea').html('<div class="alert alert-danger">Oopss!.. No results found.</div>');
				}
				else{
					//alert(data);
					$('#mainarea').html(data);
		 ...
		 $.ajax({
			...
			// data	:	'user_city='+user_city+'&user_state='+user_state+'&user_service='+user_service+'&user_type='+user_type+'&count='+count,
			 ...
			 success:	function(data)
			 {
				 ...
				 {
					$('#mainarea').html('<div class="alert alert-success">Oopss!.. No results found</div>'); 
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-12 section-heading text-center">
						<h2 class="to-animate">Clinic Directory</h2>						 
					</div>
				</div>
				<div class="row">
