			...
			<div class="container">
				<div class="row">
					...
					<br>
					 <ol class="breadcrumb pull-right" style="font-size:12px;">
						  ...
						  <li class="breadcrumb-item active">Ask a Free Question</li>
					</ol>
				...
				<div class="row">				 
					<div class="col-sm-6 col-sm-offset-3 advertise" style="background:white;margin-top:0px;padding:30px;font-size:12px;">
						...
						<h3  class="text text-center text-success">Ask a Free Question</h3>
						<?php
						...
						?>
						<form method="post" action="<?= base_url('askaquestion/store');?>">
							<div class="form-group">
							<label for="q_email">Email address:</label>
							<input type="email" class="form-control" required id="q_email" name="q_email" value="<?php if(isset($user['user_email'])) echo $user['user_email'];?>" placeholder="Enter email">
							</div>
							<div class="form-group">
							<label for="q_user_name">Name:</label>
							<input type="text" class="form-control" required id="q_user_name" name="q_user_name" value="<?php if(isset($user['user_fname'])) echo $user['user_fname']." ".$user['user_sname'];?>" placeholder="Enter name">
							</div>
							<div class="form-group">
							<label for="q_mobile">Mobile:</label>
							<input type="number" maxlength="10" class="form-control" required id="q_mobile" name="q_mobile" value="<?php if(isset($user['user_mobile'])) echo $user['user_mobile'];?>" placeholder="Enter Mobile">
							</div>
							<div class="form-group">
							<label for="q_sub">Subject:</label>
							<input type="text" class="form-control" required id="q_sub" name="q_sub" placeholder="Enter Subject ">
							</div>						 
							<div class="form-group">
							<label for="q_name">Message:</label>
							<textarea class="form-control" name="q_name" id="q_name" required placeholder="Enter Your question"></textarea>
							</div>							 
