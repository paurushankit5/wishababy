  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('expert/profile');?>">My Profile</a></li>
      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <div class="box-tools pull-right">
            <a href="<?= base_url('expert/profile');?>" class="btn btn-primary">My Profile</a>
          </div>
          </div>
        </div>
        <div class="box-body">
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('expert/update');?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input type="text" style="width:90%;float:right;" required class="form-control" id="user_fname" name="user_fname" value="<?= $me['user_fname'];?>" placeholder="Enter First Name">
...
<script>
  ...
  function showcity(str)
  {
	  ...
	  else
	  {
		  $.ajax({
			  type	:	'POST',
			  url	:	'<?= base_url('expert/showcities');?>',
			  data	:	'city_state='+str,
