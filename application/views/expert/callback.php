...
<head>
  ...
  <title>Expert | Callback Requests</title>
...
<script>
	...
	function savecall()
	{
		$.ajax({
			type		:	'POST',
			url			:	'<?= base_url('expert/updatecall');?>',
			data		:	{
								'call_id'		:	$('#call_id').val(),
								'call_status'	:	1,
							},
...
<button type="button"  id="callbackbtn" class="btn btn-info btn-lg hidden" data-toggle="modal" data-target="#callbackmodal">Open Modal</button>
