...
<head>
  ...
  <title>Clinic | My Appointments</title>
									...
									<tr>
										...
										<td>
											<?php
												...
												{
													echo "Appointment confirmed by you";
												}
										...
										<td>
											<?php
												...
												{
													?>
													<a href="#" onClick="approve('<?= $x['ap_id'];?>');" style="width:100px;" class="btn btn-primary btn-sm">Approve</a>
													<br>
													<br>
													<a href="#" onClick="cancel('<?= $x['ap_id'];?>');" style="width:100px;" class="btn btn-danger btn-sm">Cancel</a>
