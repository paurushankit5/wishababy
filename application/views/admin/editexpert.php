  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('admin/expertdetails/'.$me['user_id']);?>"><?= $me['user_fname']." ".$me['user_sname'];?></a></li>
        <li><a href="#">Edit Expert</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Expert Profile</h3>
        ...
        <div class="box-body">
			 <?php
			  ...
			  ?>
			<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/expertupdate');?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input type="hidden"   class="form-control"  name="preimage" value="<?= $me['user_image'];?>" placeholder="Enter First Name">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_sname"> Sur Name:</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="input-group">
							...
							<input type="text" pattern="[0-9]{10}"  maxlength="10" required class="form-control" value="<?= $me['user_mobile']; ?>" id="user_mobile" name="user_mobile" placeholder="Enter Mobile">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_tel">Alternate Contact:</label>
					<div class="col-sm-10">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">+91</span>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_pin">Pincode:</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_image"> Profile Pic:</label>
					<?php
						if($me['user_image']!='')
						{
							?>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_about"> About Me:</label>
					<div class="col-sm-10">
						<textarea class="form-control" name="user_about"  id="user_about" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $me['user_about']; ?></textarea>
              		</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_service">Services:</label>
					<div class="col-sm-10">
						<select class="form-control" required id="user_service" name="user_service">
							...
							<?php
								if(count($service))
								{
									...
									{
										?>
										<option  <?php if($me['user_expert_specality']==$x['service_name'])echo "selected"; ?> ><?= $x['service_name']; ?></option>
										<?php
									}
								}
							?>
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_expert_job">Job Title:</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="user_expert_job" value="<?= $me['user_expert_job']; ?>" name="user_expert_job" placeholder="Job Title">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="user_expert_qualification"> Qualifications:</label>
					<div class="col-sm-10">
						<textarea class="form-control" name="user_expert_qualification" id="user_expert_qualification" placeholder="Qualifiaction"><?= $me['user_expert_qualification'];?></textarea>
              		</div>
				</div>
				<div class="form-group">
