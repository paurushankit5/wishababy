  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
			 <?php
				if($this->session->flashdata('addmenumsg'))
				{
					echo $this->session->flashdata('addmenumsg');
				}
			  ?>
			<form class="form-horizontal" method="post" action="<?= base_url('admin/storemenu');?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<label><input type="radio"   checked value="0" name="menu_top"> Primary Menu</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label><input type="radio"     value="1" name="menu_top"> Top Menu</label>
					</div>
				</div>				 
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" required class="form-control" id="menu_title" name="menu_title" placeholder="Enter Page Title">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="menu_keyword"> Meta Keyword:</label>
					<div class="col-sm-10">
						<textarea class="form-control" id="menu_keyword" name="menu_keyword" placeholder="Enter meta keywords"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="menu_description"> Meta Description:</label>
					<div class="col-sm-10">
						<textarea class="form-control" id="menu_description" name="menu_description" placeholder="Enter a brief details"></textarea>
					</div>
				</div>
				<div class="form-group"> 
