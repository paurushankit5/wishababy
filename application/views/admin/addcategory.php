  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
			 <?php
				if($this->session->flashdata('addcatmsg'))
				{
					echo $this->session->flashdata('addcatmsg');
				}
			  ?>
			<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/storecategory');?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="file" required class="form-control" id="cat_image" name="cat_image" placeholder="Enter email">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control"  	id="cat_details" name="cat_details"  ></textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<textarea class="form-control" id="cat_keyword" name="cat_keyword" placeholder="Enter meta keywords"></textarea>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="cat_description"> Meta Description:</label>
					<div class="col-sm-10">
						<textarea class="form-control" id="cat_description" name="cat_description" placeholder="Enter a brief details"></textarea>
					</div>
				</div>
				<div class="form-group"> 
