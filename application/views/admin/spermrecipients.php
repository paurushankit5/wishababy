...
<head>
  ...
  <title>Admin | Sperm Recipents</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Sperm Recipents</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Sperm Recipents</h3>
				...
				<tbody>
					<?php
						...
						else
						{
							?>
								<tr>
									<td colspan="4"><div class="alert alert-warning">No sperm recipents found.</div></td>
								</tr>
							<?php
						}
					?>
