...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
     Manage Submenu Order
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?= base_url('');?>"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="<?= base_url('admin/');?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="#">Manage Submenu Order</a></li>
    ...
    <section class="content">
      ...
      <div class="box" style="padding-right:30px;padding-bottom:30px;">
        <div class="box-header with-border">
          <h3 class="box-title">Manage Submenu Order</h3>
        ...
        <div class="box-body">
			...
			<?php
				...
				{ 
					?>
					<select class="form-control" id="menu_id" onChange="showsubmenu(this.value)" name="menu_id">
						<option value="">Select a Menu First	</option>
					<?php
					foreach($menu as $x)
					{
						?>
						<option value=<?php echo $x["menu_id"]; ?>><?php echo $x["menu_name"]; ?></option>
						<?php
					}	
					?>
					</select>
			...
			?>
			<form name="frmQA" method="POST" action="<?= base_url('admin/savesubmenuorder');?>" />
...
<script>
	function showsubmenu(str)
	{
		if (str!='')
		{
			$.ajax({
				type	:	'POST',
				url		:	'<?= base_url('admin/showsomeorderedsubmenu');?>',
				data	:	'submenu_menu_id='+str,
				beforeSend:	function()
				{
					$('#space').html('<center><i class="fa fa-spinner fa-spin" style="font-size:24px"></i> Loading</center>'); 
				},
