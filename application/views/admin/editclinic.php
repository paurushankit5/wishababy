  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('admin/clinic');?>">IVF Clinics</a></li>
        <li><a href="<?= base_url('admin/clinicdetails/'.$me['user_id']);?>"><?= $me['user_clinic_name'];?></a></li>
        <li><a href="#">Edit Clinic</a></li>
      ...
      <div class="box">
        ...
        <div class="box-body">
			 <?php
			  ...
			  ?>
			<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('admin/updateclinic');?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="input-group">
							...
							<input type="text" required pattern="[0-9]{10}"  maxlength="10" class="form-control" value="<?= $me['user_mobile']; ?>" id="user_mobile" name="user_mobile" placeholder="Enter Mobile">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">+91</span>
							<input type="text" class="form-control" pattern="[0-9]{10}"  maxlength="10" value="<?= $me['user_tel']; ?>" id="user_tel" name="user_tel" placeholder="Alternate Contact Details">
						</div>
					</div>
				</div>
						...
						<select class="form-control" required id="user_service" name="user_service">
							...
							<?php
								if(count($service))
								{
									...
									{
										?>
										<option  <?php if($me['user_service']==$x['service_name'])echo "selected"; ?> ><?= $x['service_name']; ?></option>
										<?php
									}
								}
							?>
